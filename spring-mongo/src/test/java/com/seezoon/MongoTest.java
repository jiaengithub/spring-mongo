...
import com.seezoon.mongo.dao.ChildDao;
import com.seezoon.mongo.dao.PersonDao;
import com.seezoon.mongo.entity.Child;
import com.seezoon.mongo.entity.Person;
...
public class MongoTest {
	...
	public void t4(){
		...
		criteria1.orOperator(criteria2);
		Query query = new Query(criteria1);
		// 排序
		Direction direction=Direction.ASC;
		query.with(new Sort(direction, "name"));//可以添加多个字段
		query.with(new Sort(new Order(direction,"name",null).ignoreCase()));
